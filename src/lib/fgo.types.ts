...
export type FgoResult =
  ...
  | { ok: false; status: FgoInvoiceStatus; errors: Array<{ code: string; message: string }> };
...
export const FGO_STATUS_TONES: Record<FgoInvoiceStatus, "neutral" | "info" | "warning" | "danger" | "success"> = {
