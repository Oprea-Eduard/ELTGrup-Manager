	...
	return (
		<form action={formAction} className="space-y-5">
			<div className="grid gap-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.9fr)]">
				<div className="space-y-4">
					<div className="space-y-2">
						...
						<Input
							name="title"
							placeholder="Ex: Contract executie etapa 2"
							required
						/>
						<p className="text-xs text-[var(--muted)]">
							Nume scurt si clar, folosit in cautare si in listarea
							documentelor.
						</p>
						{state.errors?.title ? (
					...
					<div className="space-y-2">
						...
						/>
						<p className="text-xs text-[var(--muted)]">
							Incarca PDF, imagini, arhive sau orice fisier relevant pentru
							proiect.
						</p>
						{state.errors?.file ? (
							<p className="text-xs text-[var(--danger)]">
					...
					<div className="space-y-2">
						...
						<Input
							name="tags"
							placeholder="plan:hvac, avizare, oferta, revizie"
						/>
						<p className="text-xs text-[var(--muted)]">
							Separă cu virgule. Foloseste tag-uri ca{" "}
				...
				<div className="space-y-4">
					<div className="space-y-2">
						...
						<p className="text-xs text-[var(--muted)]">
							Alege tipul documentului pentru filtrare si pentru rapoarte mai
							clare.
						</p>
					</div>
					...
					<div className="space-y-2">
						...
						>
							...
							<option value="false">
								Public - conform accesului proiectului
							</option>
						</select>
						<p className="text-xs text-[var(--muted)]">
							Documentele sunt private in mod implicit pana cand alegi altfel.
						</p>
					</div>
					...
					<div className="space-y-2">
						...
						<p className="text-xs text-[var(--muted)]">
							Optional. Ajuta la urmarirea documentelor cu valabilitate
							limitata.
						</p>
					</div>
			...
			<div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-[var(--border)] bg-[var(--surface-card)]/80 px-4 py-3">
				<p className="text-xs text-[var(--muted)]">
					Leaga documentul de proiect, lucrare sau client pentru a aparea mai
					clar in sectiunile corecte.
				</p>
				<Button
					type="submit"
					disabled={pending}
