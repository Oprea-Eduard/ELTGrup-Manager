...
const priorityOptions: SelectOption[] = [
	{
		...
		label: "Scazuta",
		help: "Se poate programa dupa lucrarile urgente.",
	},
	{
		value: TaskPriority.MEDIUM,
		label: "Medie",
		help: "Nivel standard pentru executie.",
	},
	{
		value: TaskPriority.HIGH,
		label: "Ridicata",
		help: "Necesita atentie si reactie rapida.",
	},
	{
		value: TaskPriority.CRITICAL,
		label: "Critica",
		help: "Blocheaza livrarea sau un front important.",
	},
];

const statusOptions: SelectOption[] = [
	{
		value: WorkOrderStatus.TODO,
		label: "De facut",
		help: "Lucrarea este planificata, dar nu a inceput.",
	},
	{
		value: WorkOrderStatus.IN_PROGRESS,
		label: "In lucru",
		help: "Se executa in prezent.",
	},
	{
		value: WorkOrderStatus.BLOCKED,
		label: "Blocat",
		help: "Exista o dependinta sau o problema.",
	},
	{
		value: WorkOrderStatus.REVIEW,
		label: "In verificare",
		help: "Asteapta control sau aprobare.",
	},
	{
		value: WorkOrderStatus.DONE,
		label: "Finalizat",
		help: "A fost inchisa si predata.",
	},
	{
		value: WorkOrderStatus.CANCELED,
		label: "Anulat",
		help: "Nu mai trebuie executata.",
	},
];
	...
	return (
		<form action={formAction} className="mt-4 space-y-4">
			<div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
				<label className="md:col-span-2">
					...
					<span className="mt-1 block text-xs text-[var(--muted)]">
						Numele scurt folosit in lista, notificari si agenda.
					</span>
					<Input
						name="title"
						required
						placeholder="Montaj tabla acoperis - corp B"
						className="mt-2"
					/>
				...
				<label>
					...
					<span className="mt-1 block text-xs text-[var(--muted)]">
						Ziua in care lucrarea poate fi pornita in santier.
					</span>
				...
				<label>
					...
					<span className="mt-1 block text-xs text-[var(--muted)]">
						Data la care lucrarea trebuie inchisa sau predata.
					</span>
				...
				<label>
					...
					<span className="mt-1 block text-xs text-[var(--muted)]">
						Ajuta la planificare si compararea cu timpul real.
					</span>
					<Input
						name="estimatedHours"
						type="number"
				...
				<div className="md:col-span-2 xl:col-span-4">
					<label>
						...
						<span className="mt-1 block text-xs text-[var(--muted)]">
							Adauga locatie, dependinte, materiale sau observatii de executie.
						</span>
						<Textarea
							name="description"
							rows={3}
							placeholder="Descriere, checklist, dependinte, locatie exacta..."
							className="mt-2"
						/>
			...
			{!state.ok && state.message ? (
				<p className="text-sm text-[#ffb4bd]">{state.message}</p>
			) : null}
